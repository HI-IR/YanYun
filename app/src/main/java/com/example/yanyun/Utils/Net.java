...
public class Net {
     ...
     */
    public static void doGet(String url, Handler handler) {
     ...
     * @param handler   传入handler,message代号为0
     */
    public static void doGet(String baseurl, HashMap<String, String> map, Handler handler) {
        ...
        doGet(stringBuilder.toString(), handler);
    }
     ...
     */
    public static void doPost(String url, HashMap<String, String> hashMap, Handler handler) {
        new Thread(new Runnable() {
            String result = "";
